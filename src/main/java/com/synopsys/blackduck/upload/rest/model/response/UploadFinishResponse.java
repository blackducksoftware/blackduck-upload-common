...
/**
 * Data model object containing the response content from a finish of a multipart upload.
 * This object is deserialized from JSON contained in the body content of an HTTP response finishing
 * a multipart upload.
 */
public class UploadFinishResponse implements Serializable {
    ...
    /**
     * Constructor for the finish response of a multipart upload.
     ...
     */
    public UploadFinishResponse(String location, String eTag) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        UploadFinishResponse that = (UploadFinishResponse) o;
